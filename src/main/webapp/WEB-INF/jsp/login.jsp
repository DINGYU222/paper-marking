...
<head lang="en">
    <meta charset="UTF-8">
    <title>试卷自动生成系统</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="format-detection" content="telephone=no">
    <meta name="renderer" content="webkit">
    <meta http-equiv="Cache-Control" content="no-siteapp"/>
    <link rel="alternate icon" type="image/png" href="http://127.0.0.1:10088/assets/i/favicon.png">
...
<div class="header">
    <div class="am-g">
        <h1>试卷自动生成系统</h1>
        <h1>${msg}</h1>
        <p>Integrated Development Environment<br/>试卷自动生成系统</p>
    </div>
    <hr/>
</div>
<div class="am-g">
    <div class="am-u-lg-6 am-u-md-8 am-u-sm-centered">
        ...
        <form method="post" class="am-form" action="http://localhost:10088/login" method="post">
