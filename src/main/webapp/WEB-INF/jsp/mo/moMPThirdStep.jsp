                    ...
                    <form class="am-form am-form-horizontal" action="http://localhost:10088/moMP/save"
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                ...
                                <input name="name" value="${pName}" hidden="hidden"/>
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                ...
                                <input type="tel" hidden="hidden" name="difflevel" value="${pDifflevel}">
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <c:forEach var="choiceQuestion" items="${choiceQuestions}">
                                    ...
                                    <a href="/question/update/${choiceQuestion.qId}">"${choiceQuestion.qContent}</a>
                                    <br/>
                                </c:forEach>
                            </div>
                        </div>
                        ...
                        <div class="am-u-sm-9">
                            <c:forEach var="fillBlandQuestion" items="${fillBlandQuestions}">
                                ...
                                <a href="/question/update/${fillBlandQuestion.qId}">"${fillBlandQuestion.qContent}</a>
                                <br/>
                            </c:forEach>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <c:forEach var="answerQuestion" items="${answerQuestions}">
                                    ...
                                    <a href="/question/update/${answerQuestion.qId}">"${answerQuestion.qContent}</a>
                                    <br/>
                                </c:forEach>
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <c:forEach var="judgeQuestion" items="${judgeQuestions}">
                                    ...
                                    <a href="/question/update/${judgeQuestion.qId}">"${judgeQuestion.qContent}</a>
                                    <br/>
                                </c:forEach>
                            </div>
                        </div>
