    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding am-padding-bottom-0">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">编辑知识点</strong> /
                    <small>update KnowledgePoint</small>
                </div>
            </div>
            ...
            <div class="am-g">
                ...
                <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
                    <form class="am-form am-form-horizontal"
                          action="http://localhost:10088/point/update/${point.kId}" method="post">

                        <div class="am-form-group">
                            <label class="am-u-sm-3 am-form-label">知识点序号</label>
                            <div class="am-u-sm-9">
                                <input type="text" name="kNumber" value="${point.kNumber}">
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" id="user-name" name="kName" value="${point.kName}">
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <select data-am-selected="{btnSize: 'sm'}" name="cId">
                                    ...
                                    <option value="${point.course.cId}"> ${point.course.cName} </option>
                        ...
                        <%--<div class="am-form-group">--%>
                            <%--<label class="am-u-sm-3 am-form-label">创建日期</label>--%>
                            <%--<div class="am-u-sm-9">--%>
                                <%--<input type="text" name="kCreatetime" value='<fmt:formatDate--%>
                                    <%--value="${point.kCreatetime }" pattern="yyyy-MM-dd"/>'/>--%>
                            <%--</div>--%>
                        <%--</div>--%>
