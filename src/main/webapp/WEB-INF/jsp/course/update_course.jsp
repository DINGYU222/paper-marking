    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding am-padding-bottom-0">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">编辑课程</strong> /
            ...
            <div class="am-g">
                ...
                <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
                    <form class="am-form am-form-horizontal" action="http://localhost:10088/course/update/${course.cId}" method="post">
                        <div class="am-form-group">
                            <label for="user-name" class="am-u-sm-3 am-form-label">课程姓名</label>
                            <div class="am-u-sm-9">
                                <input type="text" id="user-name"  name="cName" value="${course.cName}">
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <select data-am-selected="{btnSize: 'sm'}" name="tId">
                                        ...
                                        <option value="${course.teacher.tId}"> ${course.teacher.tName} </option>
