...
//import com.papermaking.mapper.PaperExtractingMapper;
//import com.papermaking.mapper.QuestionBankMapper;
//import com.papermaking.mapper.TestPaperMapper;
...
//
//    @Autowired
//    private PaperExtractingMapper extractingMapper;
//
//    @Autowired
...
//    }
//
//    public List<QuestionBank> findQuestionByPid(String pid) {
//        return mapper.findQuestionByPid(pid);
//    }
//
//    public String save(String paperName, String cid, String testPaper, int score, int choiceSocre, int fillBlankSocre, int answerSocre, int judgeSocre) {
//        TestPaper paper = new TestPaper();
//        paper.setCreateTime(new Date());
//        String pid = snowflakeIdWorker.nextId() + "";
//        paper.setPid(pid);
//        paper.setCid(cid);
//        paper.setTestTypes(testPaper);
//        paper.setName(paperName);
//        paper.setScore(score + "");
//        paper.setChoiceSocre(choiceSocre + "");
//        paper.setFillBlankSocre(fillBlankSocre + "");
//        paper.setAnswerSocre(answerSocre + "");
//        paper.setJudgeSocre(judgeSocre + "");
//        mapper.save(paper);
//        return pid;
//    }
//
...
//     */
//    public void createPaper(int[] Y, String[] kids, String pid, String cid) {
//        //每知识点所需抽取的试题数量
